...
// #### menghitung jumlah warna edges putih di bagian U (center kuning)
            ...
            for(int j = 0; j<cubiePos[0].length; j++) {
                for(int k = 0; k<cubiePos[0][0].length; k++) {
                    ...
                    for(int l = 0; l<tempColor.length; l++) {
                        ...
                        Log.i("TAG", "#### " + tempColor[l].getColor() + ", " + tempColor[l].getDir() + ", ");
                    }
                    System.out.println();
                }
            }
    ...
    public void showCube() {
        Log.i("TAG", "#### Cubie Pos : " + Arrays.deepToString(cubiePos));
//        Log.i("TAG", "#### Cubie Pos : " + cubiePos[0][0][0].colors.toString());
//        Log.i("TAG", "#### Cubie Pos : " + cubiePos[0][0][0].getColors().toString());
        Log.i("TAG", "#### Cubie Pos : " + cubiePos[0][0][0].getColorOfDir('U'));
    }
    /**
